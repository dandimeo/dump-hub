...
export class StatusComponent implements OnInit, OnDestroy {
  ...
  errorMessage = 'Unable to retrieve history data';
  apiInterval: any;
  ...
  public getHistory(): void {
    ...
    this.apiService.getHistory(this.pagConfig.currentPage)
      .subscribe(
        (data: HistoryData) => {
          this.uploadHistory = [];
  ...
  public deleteHistory(checkSum: string): void {
    this.apiService.delete(checkSum)
      .subscribe(
        _ => {
          this.toDelete = '';
          this.deleteModal = false;
          this.setDeleteStatus(checkSum);
        },
        _ => {
  ...
  private setDeleteStatus(checksum: string): void {
